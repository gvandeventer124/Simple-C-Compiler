INCLUDE = 1;HASH = 2;INT = 3;IDENT = 4;LT = 5; GT = 6; PERIOD = 7;MAIN = 8;
...
COLON = 51;
keywords = ((INCLUDE,'include'),(INT,'int'),(FLOAT,'float'),(DOUBLE,'double'),(BOOL,'bool'),(MAIN,'main'),(IF,'if'),(SWITCH,'switch'),\
            (WHILE,'while'),(DO,'do'),(FOR,'for'),(RETURN,'return'),(TRUE,'true'),(FALSE,'false'),
            (CHAR,'char'),(ELSE,'else'),(CASE,'case'),(BREAK,'break'),(DEFAULT,'default'))
def init(src):
